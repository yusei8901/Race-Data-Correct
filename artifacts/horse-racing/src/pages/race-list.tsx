...
function getStatusBadgeProps(status: DerivedStatus) {
  switch (status) {
    ...
    case "修正要請":     return { className: "bg-red-900/50 text-red-400 border-red-800", label: "修正要請" };
...
const ALERT_STYLE_MAP: Record<string, { bg: string; border: string; hoverBorder: string; hoverBg: string; shadow: string; textColor: string }> = {
  "修正要請":   { bg: "bg-red-950/80",    border: "border-red-500",    hoverBorder: "hover:border-red-300",    hoverBg: "hover:bg-red-900/60",    shadow: "shadow-[0_0_10px_rgba(239,68,68,0.45)]",  textColor: "text-red-200" },
...
const STATUS_ROW1: StatusFilterDef[] = [
  ...
  { key: "修正要請",     label: "修正要請",     colorClass: "text-red-400",    matchStatuses: ["修正要請"] },
