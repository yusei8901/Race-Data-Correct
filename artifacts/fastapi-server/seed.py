...
def seed():
    ...
    races_seed = [
        ...
        ("中山", "中央競馬", 5, "5歳以上2勝クラス", "芝", 2200, "右回り", "曇", "稍重", "11:55", "未補正", "完了", "完了", "ユーザー2"),
        ("阪神", "中央競馬", 5, "5歳以上2勝クラス", "芝", 2200, "右回り", "曇", "稍重", "11:55", "未補正", "完了", "完了", "ユーザー2"),
        ...
        ("大井", "地方競馬", 1, "3歳未勝利", "ダート", 1200, "左回り", "晴", "良", "15:00", "未補正", "完了", "完了", "ユーザー3"),
